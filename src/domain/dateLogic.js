...
export function shiftIsoDate(date, offsetDays) {
...
export function contributionRate(total, done) {
    return total <= 0 ? 0 : done / total;
}
export function contributionLevel(total, done) {
    if (total <= 0) {
        return 0;
    }
...
export function contributionDateRange(endDate) {
